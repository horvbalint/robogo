 ...
 */
export type RoboFileQuery = mongoose.Query<any, RoboFileDocument, RoboFileQueries> & RoboFileQueries;
/**
 ...
 * ```
 */
export type RoboFileModel = mongoose.Model<RoboFileDocument, RoboFileQueries> & RoboFileStatics;
/**
 ...
 * ```
 */
export type RoboFileSchema = mongoose.Schema<RoboFileDocument, RoboFileModel, RoboFileMethods, RoboFileQueries>;
/**
 ...
 * ```
 */
export type RoboFileDocument = mongoose.Document<mongoose.Types.ObjectId, RoboFileQueries> & RoboFileMethods & {
    name: string;
    path: string;
    size: number;
    type?: string;
